...
هذا المشروع يوفر ملف CSS بسيط لتغيير الخطوط الافتراضية إلى خط **Noto Sans Arabic** الجميل والواضح. تم تصميمه خصيصاً لمستخدمي Linux وللتطبيقات التي تقبل حقن CSS (مثل Discord عبر Vencord/BetterDiscord).
