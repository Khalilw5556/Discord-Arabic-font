# 🖋️ Arabic Font for ArchLinux (Noto Sans)

هذا المشروع يوفر ملف CSS بسيط لتغيير الخطوط الافتراضية إلى خط **Noto Sans Arabic** الجميل والواضح. تم تصميمه خصيصاً لمستخدمي Arch Linux وللتطبيقات التي تقبل حقن CSS (مثل Discord عبر Vencord/BetterDiscord).
...
قم بنسخ الكود الموجود في ملف `arabic-font.css` ولصقه في قسم **Custom CSS** في إعدادات التطبيق.
